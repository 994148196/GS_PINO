...
Usage (smoke):
  python -m gs_pino.train_dn_fno --train-data dn_fno_2608/data/train.npz \
...
from gs_pino.data_dn_fno import DNFnoDataset, compute_stats, nested_train_indices, rel_l2_normalized
