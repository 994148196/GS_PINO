...
Usage:
  python -m gs_pino.generate_dn_dataset --split train --n-samples 5000 --seed 123 \
      --out-dir dn_fno_2608/data --chunk-size 500 --n-jobs 24
  python -m gs_pino.generate_dn_dataset --split train --out-dir dn_fno_2608/data --merge
"""
